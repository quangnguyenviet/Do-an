...
1. **Đầu tuần (Thứ 2):** mở tài liệu, chốt kế hoạch tuần, điền người phụ trách.
2. **Hằng ngày:** cập nhật trạng thái đầu việc theo mã WBS trong [Mục 5](./project-schedule-management.md#5-lịch-trình-chi-tiết-theo-tuần), nêu blocker sớm.
3. **Cuối tuần (Thứ 6):** cập nhật [Bảng trạng thái tuần](./project-schedule-management.md#91-bảng-trạng-thái-tuần-cập-nhật-mỗi-kỳ) 🟢/🟡/🔴.
4. **Khi có thay đổi:** làm theo [Quy trình thay đổi](./project-schedule-management.md#12-quy-trình-thay-đổi-lịch-trình) và ghi vào [Nhật ký](./project-schedule-management.md#14-nhật-ký-cập-nhật-tài-liệu-revision-history).
