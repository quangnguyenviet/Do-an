...
*   **UJ-1. Chị Lan (Phụ huynh) tìm gia sư và đăng ký học thử qua Form Khảo sát Nhu cầu**
    ...
    *   **Path**:
        1.  Chị Lan thực hiện khảo sát nhu cầu trực quan:
    ...
    *   **Climax**: Chị Lan bấm nút **"Đăng ký học thử"** (gửi yêu cầu tức thì tới Admin mà không cần điền lại thông tin rườm rà).
...
*   **Form Khảo sát Nhu cầu & Đăng ký Học thử Tức thì**: Wizard khảo sát nhu cầu trực quan dành cho phụ huynh tại trang chủ, kết hợp nút Đăng ký học thử gửi yêu cầu ghép lớp tức thì tới Admin.
...
**Description:** Cung cấp giao diện công khai cho phụ huynh khảo sát nhu cầu tìm gia sư qua Form trực quan, tra cứu danh sách gia sư phù hợp và gửi đăng ký học thử tức thì. (Thực hiện UJ-1)

**Functional Requirements:**

#### FR-1: Khảo sát nhu cầu tìm gia sư (Smart-Match Form)
Phụ huynh chưa đăng nhập có thể thực hiện khảo sát nhu cầu tìm gia sư qua Form trực quan trên trang chủ.
...
Backend nhận dữ liệu khảo sát và hiển thị danh sách gia sư phù hợp với mốc Matching Score (%).
*   **Consequences (testable):**
    *   Frontend hiển thị danh sách gia sư xếp theo Matching Score giảm dần kèm Điểm Đánh giá trung bình (Rating ★), số lượt Đánh giá sau học thử từ các phụ huynh trước, video giới thiệu bản thân và nút **"Đăng ký học thử"** tức thì.

#### FR-3: Đăng ký học thử tức thì
...
*   **Không AI Chatbot tư vấn trên trang chủ**: Thay thế chatbot bằng Form khảo sát nhu cầu trực quan để tránh rủi ro hallucination và cồng kềnh hạ tầng SSE streaming.
...
### 6.1 In Scope
*   Parent Portal: Landing Page, Form Khảo sát nhu cầu trực quan, Nút Đăng ký học thử tức thì.
...
*   **SM-2 (Smart-Match Conversion Rate - Tỷ lệ chuyển đổi)**: Ít nhất **60%** số phụ huynh hoàn thành form khảo sát thực hiện gửi đăng ký học thử.
...
*   **[ASSUMPTION-1]**: Giả định rằng phụ huynh sẵn sàng thực hiện khảo sát ngắn (mất khoảng 30 giây) để nhận danh sách gia sư ghép cặp chính xác.
